...
const forumCategories = [
	{
		...
		description:
			"Discussions about writing techniques, character development, worldbuilding, and more.",
		topics: 3254,
		posts: 25431,
		icon: PenTool,
	},
	{
		...
		description:
			"Talk about your favorite fandoms, series, characters, and theories.",
		topics: 5241,
		posts: 42653,
		icon: Users,
	},
...
const recentTopics = [
	{
		...
		excerpt:
			"What techniques do you use to create memorable characters? I'm struggling with making my protagonist more three-dimensional and would love some advice.",
	},
	{
		id: "topic2",
		...
		excerpt:
			"After the events of the latest film, where do you think the MCU is headed? I have some theories about the multiverse that I'd like to discuss.",
	},
	{
		id: "topic3",
		...
		excerpt:
			"I've written a post-Hogwarts story focusing on Neville Longbottom becoming the Herbology professor. Would appreciate some constructive criticism!",
	},
	{
		id: "topic4",
		...
		excerpt:
			"How do you write romance subplots that enhance the main story without feeling forced? I'm looking for advice on pacing and character chemistry.",
	},
];
...
const popularTopics = [
	{
		...
		excerpt:
			"Let's discuss the unanswered questions and plot holes in the Harry Potter series. The one that always bothered me was...",
	},
	{
		id: "topic6",
		...
		excerpt:
			"I'm compiling a list of the best worldbuilding resources and techniques. What tools, websites, or methods do you use to create detailed worlds?",
	},
];
...
const Forums = () => {
	...
	return (
		<div
			...
			style={{ backgroundImage: "url('/public/forums-background.jpg')" }}
		>
			<Header />

			<main className="flex-grow pt-24 bg-white/80 backdrop-blur-md">
				<div className="container py-8">
					{/* Hero Section */}
					<div className="mb-12 text-center">
						<h1 className="text-4xl md:text-5xl font-bold mb-4 font-serif text-primary">
							Community Forums
						</h1>
						<p className="text-muted-foreground max-w-2xl mx-auto">
							Join the conversation, share your thoughts, and connect with fellow
							fans and writers in our active community forums.
						</p>
					</div>
					...
					<div className="flex justify-between items-center mb-10">
						<div className="relative max-w-xl flex-1 mr-4">
							...
							<Input
								...
								className="pl-10 rounded-full shadow-md"
								value={searchTerm}
								onChange={(e) => setSearchTerm(e.target.value)}
							/>
						</div>
						<Button className="rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg hover:scale-105 transition-transform">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							{forumCategories.map((category, index) => (
								<motion.div
									...
									className="border rounded-xl p-5 hover:bg-secondary/50 transition-colors shadow-md"
								>
					...
					<Tabs defaultValue="recent" className="space-y-8">
						...
						<TabsContent value="bookmarked" className="m-0">
							<div className="p-12 text-center bg-muted rounded-xl">
								...
								<Button className="rounded-full px-8">Browse Forums</Button>
							</div>
						</TabsContent>
					</Tabs>
					...
					<section className="mt-16 border-t pt-12">
						<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
							<div className="bg-secondary rounded-xl p-5 text-center shadow-lg">
...
const ForumTopicItem = ({ topic }) => {
	return (
		<div className="border rounded-xl p-4 hover:bg-secondary/50 transition-colors shadow-md">
				...
				<div className="md:w-2/12 flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start text-right">
					...
					<div className="flex items-center gap-2">
						<div className="text-right text-sm hidden md:block">
							...
							<Link
								to={`/author/${topic.lastReply.author.id}`}
						...
						<Avatar className="h-8 w-8">
							...
							/>
							<AvatarFallback>
								{topic.lastReply.author.name.charAt(0)}
							</AvatarFallback>
						</Avatar>
					</div>
				</div>
